...
.сегодня{
  ...
  padding:20px 22px;margin:32px 0 10px;border-radius:0 8px 8px 0;
}
.сегодня .дата{
  font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;
...
.ярлык{
  font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;
  font-size:13px;color:var(--бледный);margin-bottom:4px;
}
.подпись-предсказания{
  font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;
  font-size:15px;font-weight:600;color:var(--текст);margin-top:12px;
}
.знак{font-size:27px;line-height:1.2;color:var(--акцент)}
.оговорка{
  font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;
  font-size:12.5px;line-height:1.45;color:var(--бледный);margin-top:7px;
}
.свой-день{
...
(function(){
  ...
  if((СЕЗОН.daily||{}).kind==="tzolkin"){
    ...
    части.push('<div class="подпись-предсказания">Предсказание на день</div>');
